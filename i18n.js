  ...
  const copy = {
    kk: {
      ...
      values: {
        ...
        '.timeline__role': ['Цифрландыру және трансформация дирекциясының басшысының орынбасары', 'Дерекқорларды сүйемелдеу бөлімінің бастығы', 'Бас маман — DBA / System Administrator', 'Бас маман — Lotus Domino DBA', 'Бизнес-талдаушы / Енгізу және тестілеу маманы', 'Енгізу және сүйемелдеу маманы'],
        '.timeline__list': [
    ...
    en: {
      ...
      values: {
        ...
        '.timeline__role': ['Deputy Head, Directorate for Digitalization and Transformation', 'Head of Database Support Department', 'Chief Specialist — DBA / System Administrator', 'Chief Specialist — Lotus Domino DBA', 'Business Analyst / Implementation and QA Specialist', 'Implementation and Support Specialist'],
        '.timeline__list': [
